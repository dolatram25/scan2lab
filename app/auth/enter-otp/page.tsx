    ...
    <div className="flex items-center justify-center w-[100vw] h-[100vh] bg-[#daf3f6]">
      <div className="w-[42%] h-[90%] flex flex-col justify-center items-center bg-white rounded-[16px] py-[44px] px-[60px] gap-4">
        ...
        <div className="flex flex-col items-start w-full gap-3 mb-2">
          ...
          <h1 className="text-[24px] font-bold text-center text-gray-900">
        ...
        <form onSubmit={handleSubmit} className="w-full h-[80%]">
          <div className="h-[60%]">
            <h3 className="text-[18px] font-semibold text-[#211028]">
              Enter OTP
            </h3>
            ...
            {error && (
              <p className="text-[#B42318] text-[13px] text-center mb-2">
                {error}
              </p>
            )}
          ...
          <button
            ...
            type="submit"
            className={`text-[14px] rounded-[99px] h-[40px] w-full ${
              otp.join("").length === 6
                ? "bg-[#0B7285] text-[#F4F6F9] cursor-pointer"
                : "bg-[#E4E8EC] text-[#727C88]"
            }`}
          >
            Verify Phone Number
          </button>
