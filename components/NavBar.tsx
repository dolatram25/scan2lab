...
const NavBar = () => {
  ...
  return (
    <nav className="w-[100vw] bg-[#FFFFFF] border border-[#F5F5F5] flex gap-40 items-center justify-between px-8 py-2">
          <div className="w-[47px] h-[38px]"><img src="/images/logo.png" alt="logo" /></div>
          ...
          <div className="flex items-center gap-4 w-[50%]">
              <div className="flex bg-[#dce6e7] gap-4 items-center border border-[#EDEDED] rounded-[99px] px-[14px] py-[10px] w-[60%]">
                ...
                <input type="text" className="text-[#383838] text-[14px] placeholder-[#383838] focus:outline-none" placeholder="Search for tests" />
              </div>

              {/* <div className="border-[#c9cccf] flex gap-1 border rounded-[99px] px-[14px] py-[10px]">
                <img src="/icons/location.svg" alt="location-icon" />
                <p className="text-[14px] text-[#211028]">Select Location</p>
              ...
              <div className="relative cursor-pointer">
                ...
                <div className="absolute top-0 right-0 w-[8px] h-[8px] rounded-full bg-[#434343] text-center flex items-center justify-center" >
                  <p className="text-[4px] text-white">10</p>
                </div>
              </div>
